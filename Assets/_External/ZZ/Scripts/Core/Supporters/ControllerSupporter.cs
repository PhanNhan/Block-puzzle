...
namespace ZZ
{
    ...
    {
		public static System.Action<string> OnTrackingShown;
		public static System.Action<string> OnTrackingHidden;
        ...
        public void OnShown()
        {
			...
			if (OnTrackingShown != null)
			{
				OnTrackingShown(m_Controller.SceneName());
			}
        }
        ...
        public void OnHidden()
        {
			...
			if (OnTrackingHidden != null)
			{
				OnTrackingHidden(m_Controller.SceneName());
			}
        }
        ...
        {
            if (cameraUI == null)
                return;//Jupiter: Don't assign cameraUI to canvas if it is null
